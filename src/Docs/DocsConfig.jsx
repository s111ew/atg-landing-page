function DocsConfig({ ref }) {
  return(
    <section ref={ref} className="config">
      ...
      <br />
      <h4>Output File</h4>
      <p>The <span className="code-snippet">outputPath</span> should point to the file where the HTML tags should be written. If the file does not exist, it will be created automatically.</p>
    </section>
  )
}
