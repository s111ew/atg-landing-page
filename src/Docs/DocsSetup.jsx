function DocsSetup({ ref }) {
  return(
    <section ref={ref} className="setup">
      ...
      <p onClick={() => {
        navigator.clipboard.writeText("OPEN_API_KEY=<your-openai-api-key>")
      }} className="code-box"><span><span className="code-red">OPEN_API_KEY</span><span className="code-red">=</span><span className="code-blue">&lt;your-openai-api-key&gt;</span> </span><span className="copy-icon">copy</span> </p>
